  ...
  let dataTags;
    ...
    data.forEach((logement) => {
        if (data.id /*=== selectedId.id*/) {
            dataTitle = logement.title;
            dataPictures = logement.pictures;
            dataDesc = logement.description;
            dataHost = logement.host;
            dataRating = logement.rating;
            dataLocation = logement.location;
            dataEquipments = logement.equipments;
    ...
    return (
        <main className="logement_display">
            ...
            <div className="logement_cards">
                <div className="logement_description">
                    <Card props={dataDesc} title={"Description"} />
                </div>
                <div className="logement_equipements">
                    <Card
                        props={dataEquipments}
                        title={"Equipements"}
                    />
                </div>
            </div>
