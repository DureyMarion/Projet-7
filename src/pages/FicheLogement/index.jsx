...
<section>
  <header className="Advertisement__header">
    <div className="Advertisement__summary-box">
      <h1 className="Advertisement__title">{dataTitle}</h1>

      <h2 className="Advertisement__location">{dataLocation}</h2>

      <div className="Advertisement__tags-box">
            {dataTags.map((tag) => (
              <Tag className="Advertisement__tag" tags={`${tag}`}/>
            ))}
      </div>
    </div>
    ...
    <div className="Advertisement__aside-box">
      <div className="Advertisement__host-box">
        <p className="Advertisement__host-name">{dataHost.name}</p>
                                <img
